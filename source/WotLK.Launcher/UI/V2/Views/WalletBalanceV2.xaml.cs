...
public partial class WalletBalanceV2 : UserControl
{
    ...
    internal event EventHandler? CreditsRequested;
    internal event EventHandler? WalletRequested;
    private void Credits_Click(object sender, RoutedEventArgs e) => CreditsRequested?.Invoke(this, EventArgs.Empty);
    private void Wallet_Click(object sender, RoutedEventArgs e) => WalletRequested?.Invoke(this, EventArgs.Empty);
    ...
    internal void SetCompact(bool compact)
    {
        ...
        Grid.SetRow(EuroWalletButton, compact ? 1 : 0); Grid.SetColumn(EuroWalletButton, compact ? 0 : 2);
        ...
        EuroAmountText.MaxWidth = compact ? 52 : double.PositiveInfinity;
    }
