...
try {
    ...
    foreach ($atlasName in @('atlas_chat','atlas_chat_loader')) {
    ...
    'PASS: actual atlas_chat.cpp and loader compiled to COFF objects against unmodified local AzerothCore headers; no link or game execution.' |
