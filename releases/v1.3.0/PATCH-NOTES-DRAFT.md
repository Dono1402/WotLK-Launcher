# Atlas Launcher 1.3.0

**Brouillon complet — version en préparation, non publiée.**

Interface repensée, lancement du jeu mieux encadré, présence des amis enrichie, compte et addons améliorés. Le profil et l’armurerie 3D sont présentés en aperçu local dans la dernière rubrique.
...
## Profil et armurerie 3D — aperçu local

- Aperçu réservé au client local pour cette préparation : le profil immersif et l’armurerie 3D doivent encore être intégrés au paquet public.
