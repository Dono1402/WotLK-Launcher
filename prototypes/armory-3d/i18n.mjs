const messages = {
  fr: {
    summaryBaseAttackPower:"Puissance d'attaque de base", summaryBaseRangedAttackPower:'Puissance à distance de base', summaryBaseSpellPower:'Bonus aux sorts de base', savedBasePowerHint:'Valeur de base sauvegardée. Les modificateurs de puissance et les bonus propres aux écoles nécessitent un relevé en jeu.', savedSpellCritUnavailableHint:'La sauvegarde ne contient pas le critique des six écoles de magie. Un relevé en jeu est nécessaire.', savedStatisticsHint:'Statistiques sauvegardées du personnage. Dernière déconnexion : {date}. Aucune capture de combat disponible.',
  ...
  en: {
    summaryBaseAttackPower:'Base attack power', summaryBaseRangedAttackPower:'Base ranged attack power', summaryBaseSpellPower:'Base spell bonus', savedBasePowerHint:'Saved base value. Power modifiers and school-specific bonuses require an in-game snapshot.', savedSpellCritUnavailableHint:'The saved record does not contain critical chance for the six magic schools. An in-game snapshot is required.', savedStatisticsHint:'Saved character statistics. Last logout: {date}. No combat snapshot available.',
