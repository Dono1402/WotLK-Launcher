...
public partial class GameViewV2 : UserControl
{
    ...
    private void ApplyLayout(AdaptiveLayoutMode mode)
    {
        ...
        double primaryActionWidth = mode == AdaptiveLayoutMode.Stacked ? 261 : 285;
        PrimaryActionButton.Width = primaryActionWidth;
        GameServerStatus.Width = primaryActionWidth;
    }
}
