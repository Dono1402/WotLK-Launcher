...
- Décrire uniquement le changement concret pour l'utilisateur.
- Utiliser une catégorie courte, par exemple Launcher, Jeu, PNJ, Addons, Profil ou Social.
- Présenter chaque changement avec un point distinct.
- Ne pas inclure de noms de classes, de lignes de code ou de détails de déploiement.
- Publier uniquement sur demande explicite de Dono.
