...
internal static class ShopPreviewData
{
    ...
    internal static ShopSnapshot Create() => new(1, "shop-preview", DateTimeOffset.UtcNow, false, 265,
        [new("character-rename", "services", new("Changement de nom", "Name change"),
            ...
            [new("eur", 500), new("gold", 3_000_000)])],
        [new(101, "Asteria", 80, false, 4_235_067), new(202, "Boreal", 70, true, null)], new(8_000));
}
